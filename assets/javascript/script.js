...
function presentQuestion(x) {
    ...
    // Pull a random array value of "correctAnswer", "incorrectAnswer1", incorrectAnswer2", or "incorrectAnswer3" out of answerArrayMod0 three times. Each new variable will determine the order of the answers so that test takers can't predict their position.//
